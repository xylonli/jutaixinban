!function () {
    ...
    var e = {
        ...
        jQuery(".probootstrap-showcase-nav ul li a").on("click", function (e) {
            var t = jQuery(this), o = t.closest("li").index();
            t.closest(".probootstrap-feature-showcase").find(".probootstrap-showcase-nav ul li").removeClass("active"), t.closest("li").addClass("active"), t.closest(".probootstrap-feature-showcase").find(".probootstrap-images-list li").removeClass("active"), t.closest(".probootstrap-feature-showcase").find(".probootstrap-images-list li").eq(o).addClass("active"), e.preventDefault()
        })
    }, l = function () {
        var e = 0;
        ...
        for (var t = function (e) {
            for (var t, o, n, a, i = e.childNodes, r = i.length, s = [], u = 0; u < r; u++) 1 === (t = i[u]).nodeType && (n = (o = t.children[0]).getAttribute("data-size").split("x"), a = {
                src: o.getAttribute("href"),
                w: parseInt(n[0], 10),
                h: parseInt(n[1], 10)
            }, t.children.length > 1 && (a.title = t.children[1].innerHTML), o.children.length > 0 && (a.msrc = o.children[0].getAttribute("src")), a.el = t, s.push(a));
            return s
        }, o = function e(t, o) {
            ...
            if (r = t(o), i = {
                galleryUID: o.getAttribute("data-pswp-uid"), getThumbBoundsFn: function (e) {
                    var t = r[e].el.getElementsByTagName("img")[0],
                        o = window.pageYOffset || document.documentElement.scrollTop, n = t.getBoundingClientRect();
                    return {x: n.left, y: n.top + o, w: n.width}
                }
            }, a) if (i.galleryPIDs) {
                for (var u = 0; u < r.length; u++) if (r[u].pid == e) {
                    i.index = u;
                    break
                }
            } else i.index = parseInt(e, 10) - 1; else i.index = parseInt(e, 10);
            isNaN(i.index) || (n && (i.showAnimationDuration = 0), new PhotoSwipe(s, PhotoSwipeUI_Default, r, i).init())
        }, a = document.querySelectorAll(e), i = 0, r = a.length; i < r; i++) a[i].setAttribute("data-pswp-uid", i + 1), a[i].onclick = function (e) {
            (e = e || window.event).preventDefault ? e.preventDefault() : e.returnValue = !1;
            var t = e.target || e.srcElement, a = o(t, function (e) {
                return e.tagName && "FIGURE" === e.tagName.toUpperCase()
            });
            if (a) {
                for (var i, r = a.parentNode, s = a.parentNode.childNodes, u = s.length, l = 0, c = 0; c < u; c++) if (1 === s[c].nodeType) {
                    if (s[c] === a) {
                        i = l;
                        break
                    }
    ...
    jQuery(document).ready(function () {
        u(), l(), jQuery(".probootstrap-gallery").length > 0 && c(".probootstrap-gallery"), d(), f(), r(), m()
